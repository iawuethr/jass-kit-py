...
class NodeStateInfo :
    ...
    def __init__(self):
        self.currentGame = GameSim(RuleSchieber()) # the randomly chosen GameSim out of the InfoSet
        self.InfoSet = [] # contains all GameSims of the InformationSet
        ...
        self.activated = 0 # 0: deactivated, 1 activated.
        self.activationNr = 0 # counts how often the node was activated - used as Np in UCT
